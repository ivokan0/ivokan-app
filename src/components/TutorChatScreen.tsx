...
const TutorChatScreen: React.FC<TutorChatScreenProps> = ({
  conversation,
  currentUserId,
  onBack,
}) => {
  ...
  // For tutors, the other user is always the student
    ...
    try {
      ...
      if (data) {
        ...
        const newMessageWithProfiles: MessageWithProfiles = {
          ...data,
          sender: conversation.tutor, // Tutor is always the sender
          receiver: student,
        };
  ...
  return (
    ...
    >
      {/* Simple header with just student name */}
      <View style={[
        styles.header, 
        { 
      ...
      <View style={[styles.inputContainer, { backgroundColor: theme.colors.surface }]}>
        <TextInput
          ...
          placeholder={t('tutor.typeMessage')}
