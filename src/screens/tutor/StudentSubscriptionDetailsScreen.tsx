...
import { findOrCreateConversation } from '../../services/messaging';
...
const TutorStudentSubscriptionDetailsScreen: React.FC = () => {
  ...
  const { subscriptionId, subscription: routeSubscription } = route.params as RouteParams;
  ...
  useEffect(() => {
    if (routeSubscription) {
      setSubscription(routeSubscription);
      setIsLoading(false);
    } else {
      loadSubscription();
    }
  }, [subscriptionId, routeSubscription]);
  ...
  const handleContactStudent = async () => {
    if (!subscription?.student?.user_id) {
      Alert.alert(t('common.error'), t('errors.student.notFound'));
      return;
    }

    try {
      // Find or create a conversation with the student
      const { data: conversation, error } = await findOrCreateConversation(
        subscription.tutor_id,
        subscription.student.user_id
      );

      if (error || !conversation) {
        console.error('Error finding or creating conversation:', error);
        Alert.alert(t('common.error'), t('errors.conversation.createFailed'));
        return;
      }
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          <Text style={[styles.headerTitle, { color: theme.colors.onSurface }]}>
            {t('tutor.subscription.details.title')}
          </Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          <Text style={[styles.cardTitle, { color: theme.colors.onSurface }]}>
            {t('tutor.subscription.details.studentInfo')}
          </Text>
          ...
          <View style={styles.studentRow}>
            ...
            <View style={styles.studentInfo}>
              ...
              <Text style={[styles.languageName, { color: theme.colors.primary }]}>
                {t('tutor.subscription.learning')} {formatLanguageName(subscription.language?.name)}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.studentActions}>
            ...
            >
              ...
              <Text style={[styles.actionButtonText, { color: theme.colors.onPrimary }]}>
                {t('tutor.subscription.details.contactStudent')}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          <Text style={[styles.cardTitle, { color: theme.colors.onSurface }]}>
            {t('tutor.subscription.details.subscriptionInfo')}
          </Text>
          ...
          <View style={styles.detailRow}>
            <Text style={[styles.detailLabel, { color: theme.colors.onSurfaceVariant }]}>
              {t('tutor.subscription.details.totalSessions')}:
            </Text>
            <Text style={[styles.detailValue, { color: theme.colors.onSurface }]}>
          ...
          <View style={styles.detailRow}>
            <Text style={[styles.detailLabel, { color: theme.colors.onSurfaceVariant }]}>
              {t('tutor.subscription.details.sessionDuration')}:
            </Text>
            <Text style={[styles.detailValue, { color: theme.colors.onSurface }]}>
          ...
          <View style={styles.detailRow}>
            <Text style={[styles.detailLabel, { color: theme.colors.onSurfaceVariant }]}>
              {t('tutor.subscription.details.totalPaid')}:
            </Text>
        ...
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          <Text style={[styles.cardTitle, { color: theme.colors.onSurface }]}>
            {t('tutor.subscription.details.sessionsProgress')}
          </Text>
          ...
          <Text style={[styles.progressDescription, { color: theme.colors.onSurfaceVariant }]}>
            {subscription.remaining_sessions > 0 
              ? t('tutor.subscription.details.sessionsRemaining', { count: subscription.remaining_sessions })
              : t('tutor.subscription.details.allSessionsUsed')
            }
          </Text>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          <Text style={[styles.cardTitle, { color: theme.colors.onSurface }]}>
            {t('tutor.subscription.details.validity')}
          </Text>
          ...
          <View style={styles.dateRow}>
            ...
            <View style={styles.dateInfo}>
              <Text style={[styles.dateLabel, { color: theme.colors.onSurfaceVariant }]}>
                {t('tutor.subscription.details.startDate')}
              </Text>
        ...
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          <Text style={[styles.cardTitle, { color: theme.colors.onSurface }]}>
            {t('tutor.subscription.details.subscriptionId')}
          </Text>
...
export default TutorStudentSubscriptionDetailsScreen;
