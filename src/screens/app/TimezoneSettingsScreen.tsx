...
const TimezoneSettingsScreen: React.FC = () => {
  ...
  const initialTimezone = profile?.timezone || systemTimezone;
  ...
  const onSave = async () => {
    try {
      ...
      Alert.alert(t('profile.saveSuccess.title'), t('profile.saveSuccess.message'));
    } catch (e) {
      Alert.alert(t('errors.save.title'), t('errors.save.message'));
    } finally {
      setIsSaving(false);
    }
  };
